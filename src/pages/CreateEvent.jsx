...
export default function CreateEvent() {
    ...
    <h2 class="text-2xl font-bold text-gray-800 mt-8 mb-6">Event Details</h2>
    ...
    <div class="mb-4">
        ...
        <label
            ...
            class="cursor-pointer flex items-center justify-center w-full h-30 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
            Choose File
        </label>
        {/* You'll typically use React state here to display the chosen file name or a preview */}
    </div>
